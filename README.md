...
- **Histórico de tocadas** — Veja as últimas 10 músicas que passaram e clique para readicionar
- **Volume individual** — Slider de volume no player
...
4. Adicione músicas do YouTube (cole o link ou o ID do vídeo)
5. Aguarde 10 segundos para adicionar a próxima (cooldown)
6. Converse no chat enquanto ouve
7. Use `/confetti` para soltar confete 🎉
8. Clique no 🔗 para compartilhar o link da sala
...
- O histórico guarda as últimas 20 tocadas
