...
Defina Build Command: npm install
Defina Start Command: node server.js
(Opcional) Adicione a env var ADMIN_PASSWORD com sua senha
📋 Como usar
Entre com seu nome
Marque "Sou administrador" e digite a senha se quiser ser admin
Entre em uma sala ou crie uma nova
Adicione músicas do YouTube (link ou ID)
Espere 10 segundos para adicionar a próxima (cooldown)
Converse no chat enquanto ouve
Suba numa cabine de DJ para tocar suas músicas
🎵 Fila consumível
